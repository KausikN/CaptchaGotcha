...
- App is hosted at [Streamlit](https://kausikn-captchagotcha.streamlit.app/)
...
- Generate image captchas
    ...
    ![Example](Data/GeneratedVisualisations/Example.png)

- Generate audio captchas

    [Example](Data/GeneratedVisualisations/Example.wav)